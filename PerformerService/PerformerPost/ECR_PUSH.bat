...
docker tag performer_post:1.0 705517780837.dkr.ecr.us-west-1.amazonaws.com/auditonme:performer_post
docker push 705517780837.dkr.ecr.us-west-1.amazonaws.com/auditonme:performer_post