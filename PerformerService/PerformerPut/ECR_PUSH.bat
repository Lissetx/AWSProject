...
docker tag performer_put:1.0 705517780837.dkr.ecr.us-west-1.amazonaws.com/auditonme:performer_put
docker push 705517780837.dkr.ecr.us-west-1.amazonaws.com/auditonme:performer_put