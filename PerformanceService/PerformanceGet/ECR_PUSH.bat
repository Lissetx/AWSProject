...
docker tag performance_get:1.0 705517780837.dkr.ecr.us-west-1.amazonaws.com/auditonme:performance_get
docker push 705517780837.dkr.ecr.us-west-1.amazonaws.com/auditonme:performance_get