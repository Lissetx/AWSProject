...
docker tag character_put:1.0 705517780837.dkr.ecr.us-west-1.amazonaws.com/auditonme:character_put
docker push 705517780837.dkr.ecr.us-west-1.amazonaws.com/auditonme:character_put