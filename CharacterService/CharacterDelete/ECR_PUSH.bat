...
docker tag character_delete:1.0 705517780837.dkr.ecr.us-west-1.amazonaws.com/auditonme:character_delete
docker push 705517780837.dkr.ecr.us-west-1.amazonaws.com/auditonme:character_delete