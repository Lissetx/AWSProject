...
docker tag director_get:1.0 705517780837.dkr.ecr.us-west-1.amazonaws.com/auditonme:director_get
docker push 705517780837.dkr.ecr.us-west-1.amazonaws.com/auditonme:director_get