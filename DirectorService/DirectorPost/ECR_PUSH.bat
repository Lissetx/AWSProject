...
docker tag director_post:1.0 705517780837.dkr.ecr.us-west-1.amazonaws.com/auditonme:director_post
docker push 705517780837.dkr.ecr.us-west-1.amazonaws.com/auditonme:director_post